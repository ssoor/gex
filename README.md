...
[![CI](https://github.com/ssoor/gex/workflows/CI/badge.svg)](https://github.com/ssoor/gex/actions?workflow=CI)
[![GoDoc](https://godoc.org/github.com/ssoor/gex?status.svg)](https://godoc.org/github.com/ssoor/gex)
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/izumin5210/gex)](https://github.com/ssoor/gex/releases/latest)
[![Go Report Card](https://goreportcard.com/badge/github.com/ssoor/gex)](https://goreportcard.com/report/github.com/ssoor/gex)
...
You can download prebuilt binaries for each platform in the [releases](https://github.com/ssoor/gex/releases) page.

### Build from source

```console
$ go get github.com/ssoor/gex/cmd/gex
```
